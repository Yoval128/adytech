        ...
        <main class="content">
            <div class="intro-section">
                <div class="intro-title">
                    <h1>Consultar Categoría (ID)</h1>
                </div>
                <div class="intro-description">
                    <p>Obtén información detallada de una categoría específica ingresando su identificador único </p>
                </div>
            </div>
            ...
            <div class="search-section">
                ...
                <form action="/category/searchById" method="GET">
                    <div class="form-group">
                        <label for="category_id">ID de la Categoria:</label>
                        <input type="text" class="form-control" id="category_id" name="category_id" placeholder="Ingresa el ID de la categoria" required>
                    </div>
